...
installTheme(){
    ...
    git clone https://github.com/lexxyhosting/MinecraftPurpleTheme.git
...
repair(){
    bash <(curl https://raw.githubusercontent.com/lexxyhosting/MinecraftPurpleTheme/main/repair.sh)
}
